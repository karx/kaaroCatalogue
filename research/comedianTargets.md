# Indian Stand-Up Comedy Scene - Target Comedians for Enrichment

## Overview
This document catalogs Indian stand-up comedians for systematic enrichment into the KaaroCatalogue Comedy Index. Comedians are organized by prominence, language, and region.

## Tier 1: Established National Acts (Priority)

### English-Language Comedians

1. **Vir Das**
   - Status: ✅ Already in catalog (comedian-003)
   - Wikipedia: https://en.wikipedia.org/wiki/Vir_Das
   - Notable: International Emmy nominee, Netflix specials

2. **Zakir Khan**
   - Status: ✅ Already in catalog (comedian-005)
   - Wikipedia: https://en.wikipedia.org/wiki/Zakir_Khan_(comedian)
...
27. **Vicky Roy**
    - ❌ INVALID TARGET: Photographer, not comedian.
    - Status: Rejected
...
- **Canvas Laugh Club** - Major venue channel
- **OML Entertainment** - Production house
- **Comedy Central India** - Network channel
- **Amazon Prime Video India** - Specials
- **Netflix India** - Specials

### Defunct but Historically Important
- **AIB (All India Bakchod)** - Pioneering collective (2012-2018)
- **EIC (East India Comedy)** - Early comedy group

## Enrichment Notes

### Language Distribution
- English: ~15 comedians
- Hindi/Hinglish: ~12 comedians
- Regional (Tamil, Urdu, Kannada): ~3 comedians

### Genre Focus
- Observational: Majority
- Political: Kunal Kamra, Varun Grover
- Storytelling: Zakir Khan, Anubhav Bassi
- Crowd Work: Harsh Gujral, Samay Raina
...
- [ ] Find personal videos (if channel exists)
- [ ] Search aggregator channels
- [ ] Extract top 10-20 videos
- [ ] Validate language classification
- [ ] Add to review queue
- [ ] Sync to catalog
